...
class Vector3 {
  ...
  // Return a *new* Vector3 for subtraction
  sub(other) {
    return new Vector3([
      this.elements[0] - other.elements[0],
      this.elements[1] - other.elements[1],
  ...
  // Return a *new* Vector3 for division by scalar
  div(scalar) {
    return new Vector3([
  ...
  // Return a *new* Vector3 for multiplication by scalar
  mul(scalar) {
    return new Vector3([
      this.elements[0] * scalar,
      this.elements[1] * scalar,
  ...
  static dot(other1, other2) {
    ...
    let d = 0; // We'll keep this as the starting point.
    
    // Now accumulate dot product into 'd'
  ...
  /**
    ...
    */
  normalize() {
    // Compute this vector's magnitude
